...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 221198250, ; hash 0xd2f37aa, from name: libaot-SalaryApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 295784104, ; hash 0x11a14ea8, from name: SalaryApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SalaryApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 31
	...
	%struct.DSOCacheEntry {
		i64 1215413435, ; hash 0x4871bcbb, from name: aot-SalaryApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SalaryApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 127
	...
	%struct.DSOCacheEntry {
		i64 1535127260, ; hash 0x5b802edc, from name: SalaryApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SalaryApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 167
	...
	%struct.DSOCacheEntry {
		i64 1985917948, ; hash 0x765eb3fc, from name: libaot-SalaryApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SalaryApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 216
	...
	%struct.DSOCacheEntry {
		i64 2466226312, ; hash 0x92ffa088, from name: aot-SalaryApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SalaryApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 280
...
@.env.3 = private unnamed_addr constant [37 x i8] c"dd588cd5-0557-48cb-9977-ce94bbffa9cd\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.salaryapp\00", align 1
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [24 x i8] c"libaot-SalaryApp.dll.so\00", align 1
